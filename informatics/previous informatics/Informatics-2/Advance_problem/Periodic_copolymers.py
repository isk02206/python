...
def is_periodic(seq1,seq2):
    ...
    return seq2*repetition == seq1 
#if repetition multiply second sequence is same with first one, return true
...
def shorthand(seq):
    ...
    if repetition == 1: # if there is only one repetition
        ...
        return '({})_{}'.format(vari,repetition)
    #return sequence and the number of repetition with this format 
